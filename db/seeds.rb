...
crater_lake = Listing.create!({title: "Crater Lake", host_id: national_park_service.id, description: "Explore the beatuty that is Crater Lake National Park in the Cascade Mountains of southern Oregon. It’s known for its namesake Crater Lake, formed by the now-collapsed volcano, Mount Mazama.", 
                ...
                crater_lake.photos.attach(io: File.open("../../app/assets/images/crater_lake"), filename: "crater_lake1.jpg")
                crater_lake.photos.attach(io: File.open("../../app/assets/images/crater_lake"), filename: "crater_lake2.jpg")
                crater_lake.photos.attach(io: File.open("../../app/assets/images/crater_lake"), filename: "crater_lake3.jpg")
                crater_lake.photos.attach(io: File.open("../../app/assets/images/crater_lake"), filename: "crater_lake4.jpg")
                crater_lake.photos.attach(io: File.open("../../app/assets/images/crater_lake"), filename: "crater_lake5.jpg")
