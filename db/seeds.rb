...
yos = Listing.create!({title: "Yosemite", host_id: 4, description: "Yosemite National Park lies in the heart of California. It flaunts 'hanging' valleys, many waterfalls, cirque lakes, polished domes, moraines and U-shaped valleys.",
...
big_sur = Listing.create!({title: "Big Sur", host_id: 4, description: "Experience one of the world's most unforgettable stretches of coastline in and around Big Sur, California.", 
...
j_tree = Listing.create!({title: "Joshua Tree", host_id: 4, description: "Arid low desert and vegetated high desert meet in Joshua Tree National Park, offering visitors stunning vistas and rewarding hikes, and incredible climbs.", 
...
zion = Listing.create!({title: "Zion", host_id: 4, description: "Zion is a beautiful, vast nature reserve in Southwest Utah offering hikes through slot canyons and endless trails through renowned red canyons", 
...
crater_lake = Listing.create!({title: "Crater Lake", host_id: 4, description: "Explore the beatuty that is Crater Lake National Park in the Cascade Mountains of southern Oregon. It’s known for its namesake Crater Lake, formed by the now-collapsed volcano, Mount Mazama.", 
                ...
                crater_lake.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/crater_lake/crater_lake1.jpg"), filename: "crater1")
                crater_lake.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/crater_lake/crater_lake2.jpg"), filename: "crater2")
                crater_lake.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/crater_lake/crater_lake3.jpg"), filename: "crater3")
                crater_lake.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/crater_lake/crater_lake4.jpg"), filename: "crater4")
                crater_lake.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/crater_lake/crater_lake5.jpg"), filename: "crater5")
...
grand_canyon = Listing.create!({title: "Grand Canyon", host_id: 4, description: "Come explore the vast canyon carved out by the Colorado River. The Grand Canyon is the most spectacular gorge in the world. Located in the state of Arizona, it cuts across the Grand Canyon National Park.", 
                ...
                grand_canyon.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/grand_canyon/grand_canyon1.jpg"), filename: "grand_canyon1")
                grand_canyon.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/grand_canyon/grand_canyon2.jpg"), filename: "grand_canyon2")
                grand_canyon.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/grand_canyon/grand_canyon3.jpg"), filename: "grand_canyon3")
                grand_canyon.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/grand_canyon/grand_canyon4.jpg"), filename: "grand_canyon4")
                grand_canyon.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/grand_canyon/grand_canyon5.jpg"), filename: "grand_canyon5")
...
redwoods = Listing.create!({title: "Redwoods", host_id: 3, description: "Come experience a true exhibit of scale and perspective when viewing the vast redwoods that this California State Park has to offer.", 
                ...
                redwoods.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/redwood/redwood1.jpg"), filename: "redwood1")
                redwoods.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/redwood/redwood2.jpg"), filename: "redwood2")
                redwoods.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/redwood/redwood3.jpg"), filename: "redwood3")
                redwoods.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/redwood/redwood4.jpg"), filename: "redwood4")
                redwoods.photos.attach(io: File.open("/Users/robfarb/Desktop/app_academy/campout_seeds/redwood/redwood5.jpg"), filename: "redwood5")
